...
// Update just the body field on an existing document. Used by the speaker-
// rename flow after a transcript is re-rendered.
export function updateDocumentBody(db: DB, matterId: string, docId: string, body: string): void {
